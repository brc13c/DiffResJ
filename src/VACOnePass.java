...
import vac.CalculateAutocorrelationOnePass;
...
public final class VACOnePass{
	...
	public static void main(String[] args) throws IOException{
		...
		if(dstNam == null || srcNam==null || wrkDir==null || numStr==null || dimStr==null){
			throw new IllegalArgumentException("Usage: java VACOnePass -src=trajectory -wrk=working_directory -dst=diffusion_summary -num=number_of_resamples -dim=data_dimensionality [-adc=diffusion_distribution_file] [-vcr=variance_cutoff_ratio]");
		}
		...
		CalculateAutocorrelationOnePass.dataDim = Integer.parseInt(dimStr);
		CalculateAutocorrelationOnePass.main(new String[]{"-src="+sourceFileName, "-dst="+workingDirName + File.separatorChar + "Autocor.vac.sdb"});
