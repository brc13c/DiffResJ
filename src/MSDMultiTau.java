...
import msd.CalculateSquareDisplacementMultiTau;
 ...
 * @author Benjamin
 */
public final class MSDMultiTau{
	
	/**
	 * This will perform an all in one calculation to get mean square displacement information.
	 * @param args {binary trajectory file, working directory, output description file, number of resamples, maximum curvature, minimum signal to noise, dimension, aggregation number}
	...
	public static void main(String[] args) throws IOException{
		...
		if(dstNam == null || srcNam==null || wrkDir==null || numStr==null || dimStr==null || curStr==null || sigStr==null || aggStr==null){
			throw new IllegalArgumentException("Usage: java MSDMultiTau -src=trajectory -wrk=working_directory -dst=diffusion_summary -num=number_of_resamples -dim=data_dimensionality -cur=maximum_curvature -sig=minimum_signal_to_noise -agg=aggregation_number [-adc=diffusion_distribution_file]");
		}
		...
		CalculateSquareDisplacementMultiTau.dataDim = dimension;
		CalculateSquareDisplacementMultiTau.main(new String[]{"-src="+sourceFileName, "-dst="+workingDirName + File.separatorChar + "SquareDisp.sd.sdb", "-agg="+aggStr});
