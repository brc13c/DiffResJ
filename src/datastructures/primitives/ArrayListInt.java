 ...
 * {@link ListIteratorInt#remove() remove} or
 * {@link ListIteratorInt#add(int) add} methods, the iterator will throw a
...
public class ArrayListInt extends AbstractListInt implements ListInt, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     */
    protected transient int[] elementDataArray;
    ...
    public ArrayListInt(final int initialCapacity) {
        ...
        this.elementDataArray = new int[initialCapacity];
    }
     ...
     */
    public ArrayListInt(final CollectionInt collection) {
    	super();
     ...
     */
     @Override
    public int lastIndexOf(final int object) {
     ...
     *
     * @return a clone of this <tt>ArrayListInt</tt> instance
     * @throws CloneNotSupportedException Should not occur.
     */
    @SuppressWarnings("PMD.PreserveStackTrace")
    public Object clone() throws CloneNotSupportedException{
        try {
        	final ArrayListInt newArr = (ArrayListInt)super.clone();
    ...
    @Override
    public int[] toArray(final int[] store) {
    ...
    protected int elementData(final int index) {
     ...
     * @return <tt>true</tt> (as specified by {@link CollectionInt#add})
     */
     @Override
    ...
    public boolean addAll(final CollectionInt collection) {
        final int[] arr = collection.toArray();
     ...
     * @throws NullPointerException if the specified collection is null
     * @see CollectionInt#contains(int)
     */
     @Override
    public boolean removeAll(final CollectionInt collection) {
     ...
     */
     @Override
    public boolean retainAll(final CollectionInt collection) {
        return batchRemove(collection, true);
    }

    private boolean batchRemove(final CollectionInt collection, final boolean complement) {
        final int[] elementData = this.elementDataArray;
        int rhead = 0;
        int whead = 0;
    ...
    private void writeObject(final java.io.ObjectOutputStream oos) throws IOException{
        ...
        for (int i=0; i<mlsize; i++){
            oos.writeInt(elementDataArray[i]);
        }
    ...
    private void readObject(final java.io.ObjectInputStream ois)
        ...
        final int[] arr = elementDataArray = new int[arrayLength];
     ...
     * returned by an initial call to {@link ListIteratorInt#next next}.
     * An initial call to {@link ListIteratorInt#previous previous} would
    ...
    public ListIteratorInt listIterator(final int index) {
        ...
        return new ArrayListListIteratorInt(index, this);
    }
     ...
     */
     @Override
    public ListIteratorInt listIterator() {
        return new ArrayListListIteratorInt(0, this);
    }
    ...
    public IteratorInt iterator() {
        return new ArrayListIteratorInt(this);
    }
     ...
     * </pre>
     * Similar idioms may be constructed for {@link #indexOf(int)} and
    ...
    public ListInt subList(final int fromIndex, final int toIndex) {
        ...
        return new ArrayListSubListInt(this, this, 0, fromIndex, toIndex);
    }
