...
/**
 * This describes the string variables in a type.
 * @author Benjamin
 *
 */
public class CharacterVariableDescription implements Immutable{
	 ...
	 */
	public CharacterVariableDescription(final String[] names, final int[] lengths){
	...
	public boolean equals(final Object toTest){
		if(toTest instanceof CharacterVariableDescription){
			final CharacterVariableDescription test = (CharacterVariableDescription)toTest;
	 ...
	 */
	public int getStringVariableIndex(final String name){
	 ...
	 */
	public String getStringVariableName(final int index){
		return names[index];
	}
	 ...
	 */
	public int getStringVariableLength(final int index){
